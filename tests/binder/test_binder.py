...
class AssemblyTests(unittest.TestCase):
    ...
    def test_every_profile_builds_independently_with_complete_visible_content(self):
        ...
        propagation_evidence = {
            "sedum-loves-fire": (("stem", "sharp pruners", "callus", "rot"), ("SED-POWO", "SED-PAT", "SED-MSU", "SED-IA")),
            ...
            "aquarium-hornwort": (("float", "plant fragment", "below the surface", "broken stems"), ("HOR-USDA", "HOR-FWS", "HOR-WA", "HOR-TROP")),
        }
