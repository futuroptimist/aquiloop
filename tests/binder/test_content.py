...
class ContentWorksheetTests(unittest.TestCase):
    ...
    def test_revised_profiles_keep_reviewer_and_unresolved_footer_fields(self):
        expected_flags = {
            "sedum-loves-fire": (
                "identity/cultivar match", "diagnostic label/detail photographs", "exposure", "medium",
                "dry-down/rain", "temperatures",
            ),
            "bird-of-paradise": (
                "species", "diagnostic label/detail photographs", "exposure", "pot/medium", "climate",
                "outdoor transition",
            ),
            "aquarium-hornwort": (
                "species/trade form", "diagnostic package/detail photographs", "tank", "livestock",
